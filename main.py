...
@client.event
async def on_ready():
    print('{}\n[>] {}  Welcome to Odin Discord TOOLS V2.1 {}'.format(Fore.RESET, Fore.RED, Fore.RESET))
    print(' ')
    ...
    print(' ')
    print('{}\n[>] {}  Loading Odin... {}'.format(Fore.RESET, Fore.RED, Fore.RESET))
    print(' ')
    print('{}\n[>] {}  Odin loaded successfully. Enjoy at your own risk! {}'.format(Fore.RESET, Fore.GREEN, Fore.RESET))
